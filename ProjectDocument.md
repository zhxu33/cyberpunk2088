...
As the producer, I ensured consistent communication within the team through a structured schedule:

- Ensured each member was clear about their responsibilities, aligning tasks with their strengths and course content.
- breakdown the project and distribute specific tasks for each memeber to work on.
...
- Develop combat mechanics (shooting, melee, and teleportation).
- Integrate enemy AI behaviors.
...
- Develop procedural level generation system.
- Create and refine maps, NPCs, and boss rooms.
...
- Host internal testing sessions and collect feedback.
- Fix critical bugs and adjust gameplay balance.
...
- [night city backgroud assets](https://free-game-assets.itch.io/free-city-backgrounds-pixel-art)
- [cyberpunk samurai assets](https://gabry-corti.itch.io/cyberpunk-samurai)
- [robotic dog assets](https://vivicat.itch.io/robot-dog-sprite-sheet)

And specially thanks to my friend Jia'en Wu for drawing the slime animations sprites for us.
...
## Boss/Enemy Initial Mechanism and Design - Xiuyuan Qi (xyqi@ucdavis.edu)
